          ...
          <table class="table table-striped table-borderless">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  @if($project->image)
                    <img src="{{ asset('storage/' . $project->image) }}" alt="{{ $project->title }}" height="45" class="rounded">
                  @else
                ...
                <td>
                  ...
                  <form action="{{ route('dashboard.projects.destroy', $project->id) }}" method="POST" id="delete-form-{{ $project->id }}" class="d-inline">
                    @csrf @method('DELETE')
                    <button type="button" class="btn btn-danger btn-xs" onclick="confirmDelete('delete-form-{{ $project->id }}', 'Proyek {{ $project->title }} akan dihapus!')">
                      <i class="ti-trash"></i>
                    </button>
                  </form>
                </td>
