...
@push('styles')
  <style>
    ...
    .blob-2 {
      ...
      bottom: 0;
      left: 80px;
      animation: floatBlob 10s 2s ease-in-out infinite reverse;
    }
  ...
  <section class="page-hero py-20 pb-16">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10 text-center">
      ...
      <p class="text-base leading-relaxed max-w-xl mx-auto" style="color:#334e68;animation:fadeUp 0.5s 0.2s ease both">
        Dokumentasi nyata hasil pekerjaan PT. Transtech Tamiang Diraja — dari servis AC & Chiller, renovasi bangunan,
        instalasi elektrikal, hingga perbaikan lantai.
      </p>
    </div>
  </section>
  ...
  <section class="py-16" style="background:#fff">
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="text-center mb-10 reveal">
        ...
        <p class="text-sm mb-5" style="color:#64748b">Klik foto untuk memperbesar. Gunakan filter untuk memilih kategori.
        </p>
        <div class="count-badge">
          Menampilkan <span id="count-num" class="mx-1">{{ $projects->count() }}</span> proyek
        </div>
      </div>
      ...
      <div class="filter-wrap mb-10 reveal">
        ...
        <!-- tampilkan berdasarkan data yang ada di database -->
        @foreach($categories as $cat)
          <!-- data-cat harus sama dengan data-cat di proj-card -->
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5" id="projGrid">
        @forelse($projects as $index => $p)
          <div class="proj-card reveal d{{ ($index % 6) + 1 }}" data-cat="cat-{{ $p->project_category_id }}"
            data-title="{{ $p->title }}">
